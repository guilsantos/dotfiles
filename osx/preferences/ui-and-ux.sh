...
set_ui_and_ux_preferences() {
    ...
    execute 'sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "RafaelAntonioLucioOSX" &&
             sudo scutil --set ComputerName "RafaelAntonioLucioOSX" &&
             sudo scutil --set HostName "RafaelAntonioLucioOSX" &&
             sudo scutil --set LocalHostName "RafaelAntonioLucioOSX"' \
        'Set computer name'
